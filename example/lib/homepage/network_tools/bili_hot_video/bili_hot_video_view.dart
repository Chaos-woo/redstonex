    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshWidgets.buildRefreshListWidget<BiliHotVideo, BiliHotVideoLogic>(
          itemBuilder: (BiliHotVideo item, int index) => BiliHotVideoWidget(item: item),
          separatorBuilder: (item, index) => Gaps.vGap10,
          onItemClick: (item, index) => XNavigator().to(RouteCompose.biliRoute.videoDetail, parameters: {'url': item.shortLink}),
