...
class SnackBarUtils {
  ...
  static SnackbarController _innerShowElasticSnackBar({
    String? title,
    String? message,
    Widget? titleWidget,
    Widget? messageWidget,
    ...
    if (title == null && message == null && titleWidget == null && messageWidget == null) {
      throw RsxException(RsxException.fixedErrCode, 'Rsx snack bar not found any display text');
    }
    ...
    if ((message != null && messageWidget == null) || (title != null && titleWidget == null)) {
      ...
      double minWidth = ScreenUtils.screenWidth - (margin.vertical + padding.vertical);
      if (icon != null) {
