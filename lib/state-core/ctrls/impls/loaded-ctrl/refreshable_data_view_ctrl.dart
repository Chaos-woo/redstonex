...
/// do not use this.
///
abstract class RefreshableDataViewCtrl<T> extends LoadableViewCtrl
    with
  ...
  Future<void> onCtrlInitialReady() async {
    /// only once
    onProcessOnceBeforeFirstRefresh();
  ...
  /// Only execute once in [onCtrlInitialReady], and it will
  /// not be executed after refresh operation
  void onProcessOnceBeforeFirstRefresh();
